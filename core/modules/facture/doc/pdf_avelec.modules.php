 ...
 */
class pdf_avelec extends ModelePDFFactures
{
    var $db;
    var $name;
    var $description;
	...
	function _pagehead(&$pdf, $object, $showaddress, $outputlangs)
	{
		...
		//$pdf->SetXY($posx,$posy);
		//$pdf->SetTextColor(0,0,60);
		//$pdf->MultiCell(200, 4, $outputlangs->transnoentities("Ref")." : " . $outputlangs->convToOutputCharset($object->ref), '', 'R');
