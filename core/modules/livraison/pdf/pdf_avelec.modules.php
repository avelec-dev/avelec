...
class pdf_avelec extends ModelePDFDeliveryOrder
{
	...
	function pdf_avelec($db)
	{
		...
		$this->db = $db;
		$this->name = "avelec";
		$this->description = $langs->trans("DocumentModelAvelec");
	...
	function _tableau(&$pdf, $tab_top, $tab_height, $nexY, $outputlangs)
	{
		...
		$pdf->MultiCell($larg_sign,3, $outputlangs->trans("For").' '.$outputlangs->convToOutputCharset($mysoc->name).":",'','L');
