 ...
 */
class modAvelec extends DolibarrModules
{
...
//        )
	...
	public $description = "Description of module Avelec";
	...
	public $config_page_url = 'setup.php@avelec';
	...
	public $langfiles = array('avelec@avelec');
	...
	public function __construct($db)
	{
		...
		// Dictionaries
		if (! isset($conf->avelec->enabled)) {
			$conf->avelec=new stdClass();
			$conf->avelec->enabled = 0;
		}
	...
	{
		//return $this->_load_tables('/avelec/sql/');
	}
